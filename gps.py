...
gps_display = pygame.display.set_mode((width, height))
...
def gps():
    ...
    while run_gps:
        ...
        gps_display.blit(background, (0, 0))
        # show_time()
        # show_icons()
        # add_buttons()
        round_rect(gps_display, pygame.Rect(0, height * .9, width, height * 0.1), 20, (0, 51, 61))
